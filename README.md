...
<p align="center">
  ...
  <a href="https://ffraud.com/docs/open-data"><img src="https://img.shields.io/badge/Malicious_IPs-1,249,757-e11d2c?style=for-the-badge&labelColor=0a0a0a" alt="Malicious IPs"></a>
...
<p align="center"><b>1,249,757 confirmed-malicious IP addresses and 553 high-abuse networks. Every address scored, categorised, and independently confirmed at least twice.</b></p>
<p align="center"><sub>MIT licensed &middot; no signup, no API key, no rate limits &middot; updated 10.09.2026</sub></p>
<p align="center"><a href="https://ffraud.com/docs/open-data"><img src="https://raw.githubusercontent.com/FFraud-com/ip-fraud-database/main/assets/cta/en.svg?v=1789009201" alt="Browse the live database on ffraud.com" width="540"></a></p>
...
- **1,249,757** confirmed-malicious IP addresses, each seen abusing something **two or more independent times**
...
|------|------:|------|
| [`threat-ips/confirmed-abusive.csv`](threat-ips/confirmed-abusive.csv) | 1,249,757 | Malicious addresses, each confirmed 2+ times, with our 0 to 100 score, the threat category (c2, malware, botnet, brute force, web attack, scanner, phishing, spam) and the infrastructure type (proxy, vpn, tor, datacenter, mobile) where known |
