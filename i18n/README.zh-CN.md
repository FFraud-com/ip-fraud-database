...
<p align="center">
  ...
  <a href="https://ffraud.com/docs/open-data"><img src="https://img.shields.io/badge/恶意_IP-1,227,199-e11d2c?style=for-the-badge&labelColor=0a0a0a" alt="恶意 IP"></a>
...
<p align="center"><b>1,227,199 个已确认的恶意 IP 地址，553 个高滥用网络。每个地址都有评分、分类，并至少经过两次独立确认。</b></p>
<p align="center"><sub>MIT 许可 &middot; 无需注册、无需密钥、没有速率限制 &middot; 更新于 07.09.2026</sub></p>
<p align="center"><a href="https://ffraud.com/docs/open-data"><img src="https://raw.githubusercontent.com/FFraud-com/ip-fraud-database/main/assets/cta/zh-CN.svg?v=1788767141" alt="在 ffraud.com 上浏览实时数据库" width="540"></a></p>
...
- **1,227,199** 个已确认的恶意 IP 地址，每一个都被**两次或以上独立观测**到在实施滥用
...
| 文件 | 行数 | 说明 |
|------|------:|------|
| [`threat-ips/confirmed-abusive.csv`](../threat-ips/confirmed-abusive.csv) | 1,227,199 | 恶意地址，每个至少经过两次确认，附我们 0 到 100 的评分、威胁分类（c2、恶意软件、僵尸网络、暴力破解、Web 攻击、扫描器、钓鱼、垃圾邮件）以及已知时的基础设施类型（proxy、vpn、tor、datacenter、mobile） |
